...
impl Sequence {
    ...
    pub(crate) fn new(tck_cycles: u8, tdo_capture: bool, tms: bool, tdi: [u8; 8]) -> Result<Self, CmsisDapError> {
        assert!(
...
impl Request for SequenceRequest {
    ...
    fn to_bytes(&self, buffer: &mut [u8]) -> Result<usize, SendError> {
        ...
        self.sequences.iter().for_each(|&sequence| {
            ...
            buffer[transfer_len_bytes..(transfer_len_bytes + byte_count)].copy_from_slice(&sequence.data[..byte_count]);
